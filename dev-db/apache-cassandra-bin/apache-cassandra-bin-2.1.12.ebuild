...
SRC_URI="mirror://apache/cassandra/2.1.12/apache-cassandra-2.1.12-bin.tar.gz"
S="${WORKDIR}/apache-cassandra-2.1.12"
...
#	java-pkg_newjar build/apache-cassandra-0.7.0-beta3-SNAPSHOT.jar ${PN}.jar || die "newjar failed"
	...
	# Docs
	dodoc CHANGES.txt LICENSE.txt NEWS.txt NOTICE.txt interface/cassandra.thrift || die "dodoc failed"
	docinto licenses
