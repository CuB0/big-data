...
SRC_URI="http://cdn.hypertable.com/packages/${PV}/${P}-src.tar.gz"
LICENSE="GPL-3"
SLOT="0"
KEYWORDS="*"
IUSE=""
...
src_configure() {
	...
	local mycmakeargs=(
		...
		-DBOOST_PYTHON_LIB=/usr/lib64/libboost_python-3.4.so
		# Not sure why CMake isn't detecting this
		-DBDB_INCLUDE_DIR=/usr/include/db6.0
		# Breaks linking with undefined linker errors
		# -DBUILD_SHARED_LIBS=on
		# Gentoo overrides this to /usr if not set
